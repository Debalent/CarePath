...
export default function PatientProfileForm({ mode }: PatientProfileFormProps) {
  const isProfileMode = mode === "profile";
  const [doctors, setDoctors] = useState<Doctor[]>([{ id: "doctor-1" }]);
  ...
  const cardStyles = "rounded-xl border-2 border-[#8b5aa5] bg-white";
  ...
  const cardFrame = {
    borderColor: "#8b5aa5",
    boxShadow:
      "0 0 0 4px rgba(255, 255, 255, 0.9), 0 0 0 8px #73418f, 0 12px 28px rgba(75, 40, 110, 0.22)",
  };
  const inputStyles =
        ...
        <div className="mb-10 text-center">
          <section
            style={{
              ...
              textAlign: "center",
              background:
                "linear-gradient(135deg, rgba(190, 125, 163, 0.92) 0%, rgba(164, 141, 193, 0.88) 55%, rgba(14, 111, 76, 0.9) 100%)",
              color: "#ffffff",
          ...
          >
            ...
            >
              {isProfileMode ? "My Profile" : "Patient Intake Profile"}
            </h1>
            ...
            >
              {isProfileMode
                ? "Keep your transportation, accessibility, medical, and contact information current so we can coordinate the best ride for you."
                : "Complete your patient intake so CarePath can coordinate safe, reliable transportation tailored to your needs."}
            </p>
          </section>
        </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              {zipLookupStatus === "error" && (
                <p className="md:col-span-2 -mt-3 text-sm font-semibold text-red-600">
                  Couldn&apos;t look up that ZIP code. Please enter city,
                  county, and state manually.
                </p>
              )}

              <label className={`${labelStyles} md:col-span-2`}>
                Date of Birth
                <input type="date" name="dateOfBirth" className={inputStyles} />
              </label>
            </div>
          </section>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <label className={labelStyles}>
                ...
                >
                  ...
                  <option value="GRANT">Grant or nonprofit assistance</option>
              ...
              <label className={labelStyles}>
                ...
                >
                  ...
                  <option value="OTHER">Other scheduling requirement</option>
                </select>
              </label>
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                ["nonTransferableWheelchair", "Non-transferable wheelchair"],
          ...
          <div className="flex flex-col-reverse gap-4 pb-8 sm:flex-row sm:justify-end">
            ...
            <button
              ...
              style={{
                minHeight: "58px",
                minWidth: "250px",
                background: "linear-gradient(90deg, #57999e 0%, #0d5083 100%)",
                boxShadow: "0 8px 20px rgba(13, 17, 27, 0.3)",
              }}
            >
              {isProfileMode ? "Save Profile Changes" : "Save Patient Intake"}
            </button>
          </div>
        </form>
      </div>
