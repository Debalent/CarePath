      ...
      <section className="w-full max-w-[820px] rounded-[22px] border border-slate-200 bg-white px-6 py-10 shadow-[0_18px_50px_rgba(69,4,102,0.14)] sm:px-10 sm:py-12 md:px-16 md:py-12">
        ...
        <div className="mb-6 flex flex-col items-center justify-center text-center">
          <Image
            ...
            width={90}
            height={90}
            className="mb-4 rounded-[10px] object-contain"
          />
        ...
        {error && (
          <div
            role="alert"
            className="mx-auto mb-6 flex w-full max-w-[660px] items-start gap-2 rounded-[10px] border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700"
          >
            <AlertCircle
              size={18}
...
>
  ...
  <button
    ...
    className="mt-2 mb-25 min-h-[58px] w-full rounded-[12px] bg-[#ae5a8b] px-6 py-4 text-[17px] font-extrabold text-white shadow-[0_6px_16px_rgba(174,90,139,0.28)] transition hover:bg-[#9d4f7d] disabled:cursor-not-allowed disabled:bg-slate-400"
  >
    {isSubmitting ? "Signing in…" : "Sign In"}
  </button>
</form>
        {/* Links */}
        <div className="mx-auto mt-9 flex w-full max-w-[720px] flex-col items-center gap-5 text-center ">
